...
public class LavoraAttivitaDto extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3707594209067016006L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"LavoraAttivitaDto\",\"fields\":[{\"name\":\"idAttivita\",\"type\":\"long\"},{\"name\":\"lavorata\",\"type\":\"boolean\"},{\"name\":\"message\",\"type\":[\"null\",\"string\"],\"default\":null}]}");
   ...
   */
  public static LavoraAttivitaDto.Builder newBuilder() {
    return new LavoraAttivitaDto.Builder();
  }
   ...
   * @return A new LavoraAttivitaDto RecordBuilder
   */
  public static LavoraAttivitaDto.Builder newBuilder(LavoraAttivitaDto.Builder other) {
    if (other == null) {
      return new LavoraAttivitaDto.Builder();
    } else {
      return new LavoraAttivitaDto.Builder(other);
    }
  }
   ...
   * @return A new LavoraAttivitaDto RecordBuilder
   */
  public static LavoraAttivitaDto.Builder newBuilder(LavoraAttivitaDto other) {
    if (other == null) {
      return new LavoraAttivitaDto.Builder();
    } else {
      return new LavoraAttivitaDto.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<LavoraAttivitaDto>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(LavoraAttivitaDto.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(LavoraAttivitaDto other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.idAttivita)) {
        this.idAttivita = data().deepCopy(fields()[0].schema(), other.idAttivita);
    ...
    /**
      ...
      * @return This builder.
      */
    public LavoraAttivitaDto.Builder setIdAttivita(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public LavoraAttivitaDto.Builder clearIdAttivita() {
    ...
    /**
      ...
      * @return This builder.
      */
    public LavoraAttivitaDto.Builder setLavorata(boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public LavoraAttivitaDto.Builder clearLavorata() {
    ...
    /**
      ...
      * @return This builder.
      */
    public LavoraAttivitaDto.Builder setMessage(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public LavoraAttivitaDto.Builder clearMessage() {
      message = null;
